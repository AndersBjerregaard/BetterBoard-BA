...
% \addbibresource{mitthesis-sample.bib} % Bibliography file
...
\hypersetup{
	pdfsubject={Automated E2E Test System for BetterBoard® ApS' Software Products},
	% Change this to briefly state topic of your thesis 
 
	pdfkeywords={UCL, BetterBoard, Software, Thesis},
	...
	pdfcontactemail={don-sbn@hotmail.com},
...
\title{Automated End-to-End Test System for BetterBoard® ApS' Software Products}
...
\Author{Anders S. B. Nielsen}{Fullstack Developer}
...
\Degree{Bachelor of Computer Science in Software Development}{Department of Education Denmark}

\Institution{University College Lillebælt, Odense Seebladsgade}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Kenneth Jepsen Clausen}{Assistant Professor of Marketing, Digital Development and Design}
...
\Acceptor{Morten Sabro Damgaard}{Bachelor Study Coordinator of Web- and Software Development}{Professor of Web- and Software Development}
